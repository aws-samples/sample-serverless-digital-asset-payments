...
8. **Sweeping Funds**
   - The Sweeper calculates required gas, requests additional ETH if needed (using the HD wallet seed phrase), and, if sufficient ETH is available, transfers tokens to the offline treasury wallet. The invoice is then marked as swept.
