...
export class CryptoInvoiceStack extends cdk.Stack {
    constructor(scope: Construct, id: string, props?: cdk.StackProps) {
        ...
        new cdk.CfnOutput(this, "InvoiceManagementFunctionName", { value: invoiceManagementFn.functionName });
        ...
        new cdk.CfnOutput(this, "PaymentNotificationTopicArn", { value: paymentNotificationTopic.topicArn });
        ...
        NagSuppressions.addResourceSuppressions(this, [
            {
                ...
                appliesTo: [
                    'Resource::<CryptoInvoices8362F00B.Arn>/index/*',
                    'Resource::*'
                ]
            }
        ], true);
