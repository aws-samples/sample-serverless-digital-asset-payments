...
use shared::{get_mnemonic, derive_keypair};
...
async fn sweep_funds(
    ...
    let treasury_address = std::env::var("TREASURY_ADDRESS")
        .unwrap_or_else(|_| "0x09e66c87d06058ee3d292bbb6284b2b9ac31bbeab0da5e1f75cec4ddf6e00b52".to_string());
